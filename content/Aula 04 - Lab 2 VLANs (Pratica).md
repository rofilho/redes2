...
<span class="au-pronto-i">Pronto quando: o PC-3 volta a pingar o `.14`, o PC-1 **para** de pingar o `.14`, e `show interfaces fa0/4 switchport` diz `Access Mode VLAN: 20 (RECEPCAO)`. **Apague também o PC-5** que você criou no exercício 4, e devolva a `Fa0/5` à VLAN 1.</span>
<span class="au-pronto-i">Atenção, correção de 25/08: o **Lab 3 não começa deste arquivo**. Ele parte da topologia nova que o pré-lab da teórica de trunking monta — dois switches, quatro PCs e outro endereçamento. Guarde este arquivo assim mesmo (ele é a prova do seu ponto), mas siga o pré-lab da teórica antes do Lab 3.</span>
