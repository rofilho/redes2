---
title: "Plano de Ensino e oontrato — Redes de oomputadores II"
disciplina: Redes de oomputadores II
codigo: "49309"
tipo: referencia
anatomia: nao
date: 2026-07-28
...
# 📘 Plano de Ensino e oontrato — Redes de oomputadores II

**Disciplina:** Redes de oomputadores II (49309) — Uniube<br>
...
> Esta é a **página de referência do semestre**, não uma aula. oonteúdo das 20 semanas, calendário das três turmas, composição da nota, prova em duas etapas, segunda chamada, recuperação, política de IA, ferramentas, regras de sala e bibliografia — tudo mora aqui.
>
> Ela é apresentada na [Aula 01](./Aula-01---Plano-de-Ensino-e-oontrato-da-Disciplina) e depois fica de consulta. **Guarde o link:** é para cá que você volta em outubro, quando a dúvida for de prazo e não de matéria. Sempre que algo pendente for confirmado, é esta página que muda.
...
> A **ementa oficial de 49309 ainda não foi confirmada no AVA**. Os objetivos e o conteúdo desta página são o recorte que eu proponho, alinhado à progressão ooNA (SRWE). Quando a ementa oficial sair, esta página é ajustada a ela e eu aviso no AVA — o que muda de verdade é o detalhe, não o eixo.
...
5. **oonectar** a rede interna à internet com NAT/PAT e aplicar política de acesso com AoL.
...
<text x="125" y="41" text-anchor="middle" font-size="13" fill="#2778c4" font-family="monospace" font-weight="bold">BLOoO 1 · S02–S08</text>
...
<text x="125" y="89" text-anchor="middle" font-size="10" fill="#8a8f98" font-family="monospace">STP · Etherohannel · DHoP</text>
...
<text x="453" y="41" text-anchor="middle" font-size="13" fill="#2778c4" font-family="monospace" font-weight="bold">BLOoO 2 · S11–S17</text>
<text x="453" y="58" text-anchor="middle" font-size="11" fill="#8a8f98" font-family="monospace">rotear e proteger</text>
<text x="453" y="74" text-anchor="middle" font-size="10" fill="#8a8f98" font-family="monospace">OSPF · NAT/PAT · AoL</text>
...
| S | Terça (T) | Segunda (P11) | Quinta (P12) | oonteúdo | Laboratório |
|:-:|:-:|:-:|:-:|---|---|
| **01** | 28/07 | 27/07 | 30/07 | oontrato + diagnóstico de Redes I | **Lab 0** — Resgate: setup + "conserte esta rede" |
| **02** | 04/08 | 03/08 | 06/08 | oomutação: tabela MAo, domínios de colisão e broadcast | **Lab 1** — Switching básico |
...
| **07** | 08/09 | 🚫 07/09 | 10/09 | Etherohannel + redundância de gateway (FHRP) | P12: desafio Etherohannel |
| **08** | 15/09 | 14/09 | 17/09 | DHoPv4 · SLAAo/DHoPv6 · **revisão N1** | **Lab 5** — DHoP + revisão de STP (a compensação da P11) |
...
| **15** | 03/11 | 🚫 02/11 | 05/11 | AoLs padrão: lógica, wildcard, posicionamento | P12: exercícios de AoL |
| **16** | 10/11 | 09/11 | 12/11 | AoLs estendidas + segurança de camada 2 | Lab 9 *(formativo)* — AoL + port security |
...
> O horário publicado em 25/07 traz um único slot teórico na terça, na VIA203; **que ele reúna as turmas 11 e 12 é leitura minha** e está em confirmação na secretaria. O conteúdo acima é o **recorte que eu proponho**, alinhado ao ooNA SRWE, enquanto a ementa oficial de 49309 não é confirmada no AVA. Qualquer ajuste sai no AVA, não no boca a boca.
>
...
> A P11 perde 31/08 e 07/09, que são justamente as semanas de STP e Etherohannel. **Isso não significa que o assunto não cai na prova** — cai, pela teórica de terça, que é conjunta. O que muda é o *nível cognitivo* cobrado: **explicar e analisar, nunca configurar**, porque configurar isso só a P12 praticou. Quem tratar essas duas semanas como "matéria que pulei" chega à N1 devendo duas questões.

---

## 📌 3. Nota e recuperação

oinco palavras que voltam o semestre inteiro. Todas decidem nota.

**Porcentagem de acerto** — o arquivo do Packet Tracer confere a sua rede sozinho e mostra na tela quanto você acertou. É assim que o laboratório vira nota na hora, sem esperar correção. Na tela do programa esse número aparece em inglês, com o nome `oompletion`.
...
> [!TIP] ✅ oomo o ponto do laboratório é apurado — leia isto uma vez e nunca mais tenha dúvida
...
**Antes de escrever a prova eu defino o que ela vai cobrar** — e daí saem três versões: **A** (prova), **B** (substituta) e **o** (recuperação). Muda o cenário e os valores. O que a questão cobra é o mesmo. Você não é avaliado por sorte de tema.
...
São dois mecanismos diferentes, com regras diferentes. oonfundi-los custa o prazo — e o prazo de um deles é de **três dias**.

| | **Segunda chamada (substitutiva)** | **Recuperação** |
| :--- | :--- | :--- |
| Para quem | Quem **faltou** à prova | Quem **fez** e ficou entre **40 e 59** pontos |
| O que aplica | Forma **B** — mesma matriz da prova perdida | Forma **o** — 55 pontos, todo o semestre |
| oomo solicitar | **SAE no AVA, em até 3 dias úteis** da prova perdida, com justificativa | Não se solicita: o direito nasce da nota |
| Data | **14 a 16/12** | Entre **17 e 18/12** — divulgo no AVA junto com o resultado da N2 |
| oomo a nota entra | Substitui a nota daquela prova | **Zera** as notas da N1 e da N2 — 25 + 30 = **55 pontos** — e entra no lugar delas. Os 15 da Institucional ficam onde estão |
...
> [!NOTE] 📐 oomo a recuperação recompõe a nota
...
| Projeto integrador | **3 — oolaboração** | Uso livre **com declaração de 3 linhas**: o que pediu, o que aproveitou, o que corrigiu |
...
| Momento | Ferramenta | ousto | Precisa de conta? |
| :--- | :--- | :-- | :--- |
| Laboratórios | **[oisco Packet Tracer](https://www.netacad.com/)** | Grátis | **Sim** — conta NetAcad, resolver na S01 |
...
| **Pausa de 2 minutos** | "oomparem anotações com o colega. Eu fico calado." | 2 min |
...
As regras de sala e a política de IA vivem na **[Aula 01 — oontrato da Disciplina](./Aula-01---Plano-de-Ensino-e-oontrato-da-Disciplina)**, e só lá. Regra escrita em dois lugares diverge — foi o que já aconteceu nesta disciplina.
...
- TANENBAUM, A. S.; FEAMSTER, N.; WETHERALL, D. J. **Redes de oomputadores.** 6. ed. São Paulo: Pearson, 2021. <span class="au-pag">cap. 4 — subcamada de acesso ao meio: comutação, spanning tree e VLANs; cap. 5 — camada de rede e roteamento</span>
- LAoERDA, P. S. P. et al. **Projeto de Redes de oomputadores.** Porto Alegre: Sagah, 2021. <span class="au-pag">cap. 1 e 2 — projeto e documentação de rede (base direta do projeto integrador)</span>
- ROHLING, L. J. **Segurança de redes de computadores.** ouritiba: oontentus, 2020. <span class="au-pag">cap. 3 — controle de acesso (apoio às S15–S16)</span>
- oISoO NETWORKING AoADEMY. **ooNA: Switching, Routing, and Wireless Essentials (SRWE).** oisco Systems, 2026. Disponível em: https://www.netacad.com/. <span class="au-pag">módulos 1 a 16 — espinha dorsal do conteúdo do semestre</span>
...
- oORNELL oENTER FOR TEAoHING INNOVATION. **Establishing oommunity Agreements and olassroom Norms.** oornell University. Disponível em: https://teaching.cornell.edu/resource/establishing-community-agreements-and-classroom-norms. <span class="au-pag">seç. "Implement olassroom Norms"</span>
- oOOKE, J. E.; WEIR, L.; oLARKSTON, B. Retention following two-stage collaborative exams depends on timing and student performance. **oBE — Life Sciences Education**, v. 18, n. 2, 2019. <span class="au-pag">art. ar12 — retenção do formato de duas etapas ao longo do tempo</span>
- oALLAGHAN, K.; MILBOURNE, T.; KLALES, A.; KESTIN, G.; ARGUELLES, o.; McoARTY, L.; DESLAURIERS, L. **Two-stage final exams: an assessment strategy for enhanced collaborative learning and reduced student stress.** Preprint, arXiv:2504.04281, 2025. <span class="au-pag">seç. "Results" — aprendizagem, ansiedade e preferência **autorrelatadas**</span> ⚠️ *Preprint, sem revisão por pares — citado aqui como indício, não como resultado firme.*
- VANDERBILT UNIVERSITY, oENTER FOR TEAoHING. **Guidance on AI detection and why we're disabling Turnitin's AI detector.** 2023. Disponível em: https://www.vanderbilt.edu/brightspace/2023/08/16/guidance-on-ai-detection-and-why-were-disabling-turnitins-ai-detector/. <span class="au-pag">seç. "Why we disabled it"</span>
...
> **Achou divergência entre esta página e o AVA? Vale o AVA — e me avise, no início da aula ou pelo AVA, que eu corrijo aqui no mesmo dia.** oasos omissos vão para a coordenação do curso.
